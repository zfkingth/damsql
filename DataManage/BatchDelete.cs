    ...
    public partial class BatchDelete : DevExpress.XtraEditors.XtraUserControl, hammergo.Utility.IShowAppData
    {
        ...
        private void btnOut_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (XtraMessageBox.Show(this, "确定要删除选定测点在指定日期的数据吗!", "删除数据", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2)
                == DialogResult.OK)
                {
                ...
                if (delApps != null)
                {
                    ...
                    for (int i = 0; i < count; i++)
                    {
                        ...
                        if (percentComplete > highestPercentageReached)
                        {
                            ...
                            worker.ReportProgress(percentComplete, "正在删除......");
                        }
